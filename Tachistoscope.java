...
public class Tachistoscope {
    ...
    public void parseFileToRead() {
        try {
                ...
                if (wordArray[i].length() >= preferredLineLength) {
                    ...
                    while (newLineObj.wordLength < 4 && i < wordArray.length) {
                        ...
                        if (wordArray[i].equals("and")
                                || wordArray[i].equals("but")
                                || wordArray[i]
                                        .charAt(wordArray[i].length() - 1) == '.') {
            ...
            FontMetrics fm = this.flashLabel.getFontMetrics(new Font("Serif",
                    Font.PLAIN, 24));
            int maxLineLength = 0;
            int len;
            for (Line line : lines) {
    ...
    public void unbindSetFlashIntervalMenuItem() {
        ...
        setVisibilityDurationMenuItem
                .removeActionListener(setVisibilityDurationAction);
    }
    ...
    public void bindSetFlashIntervalMenuItem() {
        ...
        setVisibilityDurationMenuItem
                .addActionListener(setVisibilityDurationAction);
    }
    ...
    public void setVisibilityDuration() {
        ...
        String s = (String) JOptionPane.showInputDialog(jframe,
                ...
                "Set Visibility Duration", JOptionPane.PLAIN_MESSAGE, null,
                null, this.visibilityDuration);
        if ((s != null) && (s.length() > 0)) {
            try {
                ...
                if (visibilityDuration <= 0)
                    ...
                    throw new IllegalArgumentException(
                            "Input must be less than or equal to the flash interval.");
                else
            ...
            JFrame errorDialog = new JFrame();
            JOptionPane.showMessageDialog(errorDialog, "No change was made.");
        }
    }
    ...
    public void setFlashInterval() {
        ...
        String s = (String) JOptionPane.showInputDialog(jframe,
                ...
                "Set Flash Interval", JOptionPane.PLAIN_MESSAGE, null, null,
                this.flashInterval);
        if ((s != null) && (s.length() > 0)) {
            try {
    ...
    public void startFlash() {
        ...
        scheduler.scheduleAtFixedRate(beeper, (long) 50,
                (long) this.flashInterval, TimeUnit.MILLISECONDS);
        if (visibilityDuration < flashInterval)
            scheduler.scheduleAtFixedRate(clearLineRunnable,
                    (long) (visibilityDuration + 50),
                    (long) this.flashInterval, TimeUnit.MILLISECONDS);
    }
    ...
    public void loadTextFileToRead() {
        ...
        FileDialog fileDialog = new FileDialog(loadFileFrame,
                "Choose Text to Read", FileDialog.LOAD);
